...
var Log = (function () {
    ...
    Log.getConsolePrefix = function (namespace, features, lastLogTime) {
        ...
        if (features.date == true || features.time == true) {
            ...
            var month = padStart_1.default((date.getMonth() + 1).toString(), 2, '0');
            var day = padStart_1.default(date.getDate().toString(), 2, '0');
            var hours = padStart_1.default(date.getHours().toString(), 2, '0');
            var minutes = padStart_1.default(date.getMinutes().toString(), 2, '0');
            var seconds = padStart_1.default(date.getSeconds().toString(), 2, '0');
